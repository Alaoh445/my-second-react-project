...
import './index.css'
import Road from './assets/NatureQ/NatureQ7.avif'
...
const styles = {
  ...
  return (
    ...
    <div style={styles.EuroCamper1}>
      ...
      <h1 style={{fontSize: '50px', paddingLeft:isMobile ? '20px'  : '0px',  fontWeight:500}}>EuroCamper</h1>
      <p style={{fontSize: '25px', paddingLeft:isMobile ? '20px'  : '0px', marginTop: isMobile? '-20px': '-10px' }}># 140,000 per night</p>
      <div>
        <img src={Road} alt="Euro Camper Image" style={{width: '100%',height:'auto', display:isMobile? 'block' :'none'}}/>
      </div>
      <p style={{fontSize: '20px', paddingLeft:isMobile? '40px': '0px'}}>Book for your euro camper trip<br />
      ...
      <div style={styles.EuroCamper2}>
        <div style={{paddingLeft:isMobile? '20px': '0px'}}>
          ...
          <h1 style={{fontSize: '20px'}}>4 passengers</h1>
        </div>
         <div style={{paddingLeft:isMobile? '20px': '0px'}}>
         ...
         <div style={{paddingLeft:isMobile? '20px': '0px'}}>
          ...
          <h1  style={{fontSize: '20px'}}>2 Double Beds</h1>
          <p style={{marginTop: '-10px'}}>Sleep four</p>
        </div>
         <div style={{paddingLeft:isMobile? '20px': '0px'}}>

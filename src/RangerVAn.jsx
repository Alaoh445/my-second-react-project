...
import './index.css'
import Road from './assets/NatureQ/NatureQ9.avif'
...
const styles = {
  ...
  return (
    ...
    <div style={styles.EuroCamper1}>
      ...
      <h1 style={{fontSize: '50px', paddingLeft:isMobile ? '20px'  : '0px',  fontWeight:500}}>Ranger Van</h1>
      <p style={{fontSize: '25px', paddingLeft:isMobile ? '20px'  : '0px', marginTop: isMobile? '-20px': '-10px' }}># 120,000 per night</p>
      <div>

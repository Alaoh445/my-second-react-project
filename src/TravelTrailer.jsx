...
import './index.css'
import Road from './assets/NatureQ/NatureQ10.avif'
...
const styles = {
  ...
  return (
    ...
    <div style={styles.EuroCamper1}>
      ...
      <h1 style={{fontSize: '50px', paddingLeft:isMobile ? '20px'  : '0px',  fontWeight:500}}>Travel Trailer</h1>
      <p style={{fontSize: '25px', paddingLeft:isMobile ? '20px'  : '0px', marginTop: isMobile? '-20px': '-10px' }}># 110,000 per night</p>
      <div>
      ...
      <div style={styles.EuroCamper2}>
        <div style={{paddingLeft:isMobile? '20px': '0px'}}>
          ...
          <h1 style={{fontSize: '20px'}}>5 passengers</h1>
        </div>
         <div style={{paddingLeft:isMobile? '20px': '0px'}}>
         ...
         <div style={{paddingLeft:isMobile? '20px': '0px'}}>
          ...
          <h1  style={{fontSize: '20px'}}>3 Beds</h1>
